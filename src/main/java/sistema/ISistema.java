...
public interface ISistema {
        ...
        void altaRutaVuelo(String nombre, String descripcion, LocalDate fechaAlta,
                        ...
                        String nickAerolinea, String origenNombre, String destinoNombre, String nombreCategoria,
                        String urlImagen,
        ...
        void altaVuelo(String nombre, LocalDate fecha, LocalTime duracion,
                        int asientosTurista, int asientosEjecutivo, LocalDate fechaAlta, String nombreRuta,
                        String urlImagen);
        ...
        List<String> listarSeguidores(String idUsuario);

        List<String> listarSeguidos(String idUsuario);
